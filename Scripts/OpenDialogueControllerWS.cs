...
/// </summary>
///
public class OpenDialogueControllerWS : MonoBehaviour
{
    public static OpenDialogueControllerWS instance;
    ...
    {
        //Ending the dialogue
        stageDirection.instance.Clearactors();
        stageDirection.instance.gameObject.SetActive(false);
        single.SetActive(false);
        multi.SetActive(false);
    }
    ...
    public void StartDialogue()
    {
        ...
        if (Node != null)
        {
            stageDirection.instance.gameObject.SetActive(true);
    ...
    public void UpdatedialogueUi(nodeData Node)
    {
        ...
        switch (Node.type)
        {
            case TextType.SingleNode:
                ...
                stageDirection.instance.setActive(Node.character.id);
                ...
                else
                {
                    ...
                    if (image != null && stageDirection.instance.actors[Node.character.id].expression[Node.character.expression] != null)
                    { 
                        image.sprite = stageDirection.instance.actors[Node.character.id].expression[Node.character.expression]; 
                    }
                    characterName.text = stageDirection.instance.actorName(Node.character.id);
                    if (animateText)
                    {
